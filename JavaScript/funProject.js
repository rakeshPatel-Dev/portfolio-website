  ...
  function renderFunProjects() {
    ...
    funProjects.forEach(project => {
      const card = `
        <div
          class="group relative flex flex-col overflow-hidden rounded-xl border border-gray-200/80 dark:border-gray-800/80 bg-white/50 dark:bg-gray-900/50 shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
        >
